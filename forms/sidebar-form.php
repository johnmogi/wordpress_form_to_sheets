...
<span id="phone-error" class="error-message"></span>
    ...
    <input type="checkbox" id="אני מאשר/ת קבלת חומר שיווקי" name="אני מאשר/ת קבלת חומר שיווקי" checked>
    <label class="whitecheck" for="אני מאשר/ת קבלת חומר שיווקי">אישור קבלת חומר שיווקי</label><br>
